<x-wrapper title="Sua Vez">
    <div class="general-content d-flex flex-column align-items-center vh-80 mt-5">
        ...
        <div class="registro-atendimento p-4 w-75 rounded d-flex flex-column align-items-center border border-light" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); transition: box-shadow 0.3s ease-in-out;">
        ...
        <div class="mt-3">
            ...
            <a class="btn btn-secondary m-3" href="{{ route('atendente.index') }}">Editar Atendentes</a>
        </div>
    </div>
</x-wrapper>